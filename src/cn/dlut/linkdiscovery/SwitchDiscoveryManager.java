...
import cn.dlut.exceptions.PortMappingException;
import cn.dlut.packet.Ethernet;
...
public class SwitchDiscoveryManager implements LLDPEventHandler, OVXSendMsg,
    ...
    private final BasicFactory ovxMessageFactory = BasicFactory.getInstance();
    ...
    public void handleLLDP(final OFMessage msg, final Switch sw) {
        final OFPacketIn pi = (OFPacketIn) msg;
