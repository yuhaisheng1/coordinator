...
/*        https.setPort(8443);
        ...
        //userConstraint.setName(Constraint.NONE);
/*        userConstraint.setName(Constraint.__BASIC_AUTH);
        ...
        */
        ...
        uiConstraint.setName(Constraint.NONE);
        //uiConstraint.setName(Constraint.NONE.__BASIC_AUTH);
        ...
        usermapping.setPathSpec("/control");
