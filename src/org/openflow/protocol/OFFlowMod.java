...
import cn.dlut.exceptions.UnknownActionException;
import cn.dlut.util.OVXUtil;
...
public class OFFlowMod extends OFMessage implements OFActionFactoryAware,
	...
	private final Logger log = LogManager.getLogger(OFFlowMod.class.getName());
